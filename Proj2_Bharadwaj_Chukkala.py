...
def Djikstra(start, goal,obs_space):
...
######### CALLING ALL MY FUNCTIONS TO IMPLEMENT DJIKSTRA ALGORITHM ON A POINT ROBOT ###########
...
if __name__ == '__main__':
    ...
    all_nodes,flag = Djikstra(start_node, goal_node,obs_space)
